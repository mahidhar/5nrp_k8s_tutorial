...
The config files for this tutorial will have the right namespace pre-set. In general you will have your own config file with a default namespace set. You can also set the namespace in each `kubectl` command by adding `-n namespace`.
